...
if __name__ == '__main__':
    ...
    #parser.add_argument('name', help="A unique name for this scrape. Overwrites existing scrapes in the same working directory that have the same name.")
